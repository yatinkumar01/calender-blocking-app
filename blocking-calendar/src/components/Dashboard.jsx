...
const gridData = [
  {
    id: 1,
    title: "Frontend Developer Meeting",
    startTime: "12:15 PM",
    endTime: "12:45 PM",
    color: "white",
    attendies: [
      "rasalaniket00@gmail.com",
      "siddharth@gmail.com",
      "aniket@gmail.com",
    ],
  },
...
const Dashboard = () => {
  const [dropdownStates, setDropdownStates] = useState(
    Array(gridData.length).fill(false)
  );
  const [iconStates, setIconStates] = useState(
    Array(gridData.length).fill(true)
  );
            ...
            <Box>
              ...
              <Box className="linkbox">
                ...
                <a
                  ...
                  href="https://meet.google.com/iom-wevo-oji"
                >
                  https://meet.google.com/iom-wevo-oji
                </a>
              </Box>
              <br />
              ...
              <Box className="timebox">
                <Button className="fontbtn" colorScheme="purple">
                  Edit
                </Button>
                <Button className="fontbtn" colorScheme="red">
                  Delete
                </Button>
              </Box>
            </Box>
